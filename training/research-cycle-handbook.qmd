...
Based on our material, it is easy to build a tailored research practice handbook for your own research group (see [example](https://doi.org/10.5281/zenodo.16262260)):<!-- to make plural and link to internal page with more examples when exists-->
...
- use our lab-handbook template as a starting place (in development - ETA end 2026) <!-- should this be a quarto website or something easier to edit? -->
...
**Ihle Malika, Gupta Reema, Schönbrodt Felix, April 2026, Open Research Cycle Handbook [https://lmu-osc.github.io/training/research-cycle-handbook.html](https://lmu-osc.github.io/training/research-cycle-handbook.html) CC.BY.-SA 4.0 LMU Open Science Center** 
<!-- TODO: Update reference when new release or new URL domain. -->
