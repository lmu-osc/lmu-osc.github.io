...
- **Keep your raw data as read-only files.** The unmodified output of your instruments, surveys, or observations should never be modified directly. You should provide enough documentation to recreate your processed datasets and results from your raw data (see [3.1. Data Processing & Analyses](03-analyze-and-collaborate.html#sec-data-processing-analysis){.mark}).
...
<a href="https://ree-gupta.github.io/lmu-osc.github.io/training/open_research_cycle/02-collect-and-manage_website.html#osf" class="stretched-link" target="_blank" rel="noopener"> </a>
</div>
