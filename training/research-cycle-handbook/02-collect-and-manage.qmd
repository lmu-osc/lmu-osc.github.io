...
<h2 class="accordion-header no-anchor" id="sec-data-collection">
...
<i class="bi bi-journal-code m-0 fs-5"></i>
</span>
<div class="accordion-title">

### Data Collection {.fs-5}
</div>
</button>
</h2>
...
<div class="accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordionExample">
<div class="accordion-item">
<h2 class="accordion-header no-anchor" id="sec-data-management">
<button class="accordion-button collapsed fw-semibold d-flex align-items-center gap-3" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapseTwo"
  aria-expanded="false">
<span class="icon-wrapper rounded-4 bg-success-subtle text-primary p-3">
<i class="bi bi-folder-check m-0 fs-5"></i>
</span>
<div class="accordion-title">

### Data Management {.fs-5}
</div>
</button>
</h2>
...
<div class="accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordionExample">
<div class="accordion-item">
<h2 class="accordion-header no-anchor" id="sec-ethics-and-privacy">
<button class="accordion-button collapsed fw-semibold d-flex align-items-center gap-3" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapseThree"
  aria-expanded="false">
<span class="icon-wrapper rounded-4 bg-success-subtle text-primary p-3">
<i class="bi bi-shield-lock m-0 fs-5"></i>
</span>
<div class="accordion-title">
...
<div class="accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordionExample">
<div class="accordion-item">
<h2 class="accordion-header no-anchor" id="sec-quality-control">
<button class="accordion-button collapsed fw-semibold d-flex align-items-center gap-3" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapseFour"
  aria-expanded="false">
<span class="icon-wrapper rounded-4 bg-success-subtle text-primary p-3">
<i class="bi bi-check2-square m-0 fs-5"></i>
</span>
<div class="accordion-title">

### Quality Control {.fs-5}
</div>
</button>
</h2>
