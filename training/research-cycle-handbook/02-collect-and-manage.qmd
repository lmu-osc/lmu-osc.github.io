...
::: {.content-visible unless-format="html"}
* [eLabFTW](https://elab.ub.lmu.de/login.php): Electronic Lab Notebook hosted by LMU Munich.
:::
...
::: {.content-visible unless-format="html"}
* [Chemotion](https://chemlab.cup.uni-muenchen.de/home): ELN hosted by the Faculty for Chemistry and Pharmacy.
:::
...
<div class="card orc-card-tool p-3 bg-light-subtle h-100">
    ...
    <p class="card-text">File sync and share service for LMU Munich.</p>
    <a href="https://syncandshare.lrz.de/login" class="stretched-link" target="_blank" rel="noopener"> </a>
</div>
```

::: {.content-visible unless-format="html"}
* [LRZ Sync & Share](https://syncandshare.lrz.de/login): File sync and share service for LMU Munich.
:::
...
<div class="card orc-card-tool p-3 bg-light-subtle h-100">
    ...
    <p class="card-text">Data-intensive research storage for LMU Munich.</p>
    <a href="https://doku.lrz.de/data-science-storage-10745685.html" class="stretched-link" target="_blank" rel="noopener"> </a>
</div>
```

::: {.content-visible unless-format="html"}
* [LRZ DSS](https://doku.lrz.de/data-science-storage-10745685.html): Data-intensive research storage for LMU Munich.
:::
