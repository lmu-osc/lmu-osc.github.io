...
**Document both the instrument and the administration procedure completely.** Use validated instruments when possible and pilot test before deployment. The data dictionary (or 'codebook') should record the exact version of the questionnaire used; if copyright allows it, document the item wording itself. 

<!-- do we want anything else here? Could we minimally explain what validating a survey means? It is really unclear to me given how people use it...-->
...
#### 2.1.5. Systematic reviews and meta-analyses
