...
- **Digitalize your data soon after data collection**, e.g. using data entry form from a relational database such as [MySQL](https://www.mysql.com/)
...
<div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
  <div class="d-flex gap-2">
    <div class="orc-card-tool-icon p-2 rounded">
      <img src="https://www.svgrepo.com/show/303251/mysql-logo.svg" class="img-fluid" alt="MySQL icon">
    </div>
  </div>
</div>
<h4 class="card-title">MySQL</h4>
<p class="card-text">Open source relational database software</p>
<a href="https://www.mysql.com/" class="stretched-link" target="_blank" rel="noopener"></a>
</div>
```
:::
