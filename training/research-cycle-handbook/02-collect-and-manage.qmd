...
# Collect & Manage {#sec-collect-and-manage-chapter}
...
<span class="badge rounded-5 fs-6 fw-normal text-wrap orc-hero-pills phase-2"><i class="bi bi-check2-circle me-1"></i> Data Collection</span>
<span class="badge rounded-5 fs-6 fw-normal text-wrap orc-hero-pills phase-2"><i class="bi bi-check2-circle me-1"></i> Data Management</span>
<span class="badge rounded-5 fs-6 fw-normal text-wrap orc-hero-pills phase-2"><i class="bi bi-check2-circle me-1"></i> Ethics & Privacy</span>
<span class="badge rounded-5 fs-6 fw-normal text-wrap orc-hero-pills phase-2  
"><i class="bi bi-check2-circle me-1"></i> Quality Control</span>
</div>
<div class="orc-hero-checkpoint phase-2 badge rounded-5 d-inline-flex align-items-center justify-content-center text-wrap white-space-normal fs-6 fw-normal">
...
<!--first accordion -->
<div class="accordion rh-accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordion-data-collection">
<div class="accordion-item">
<div class="accordion-header no-anchor">
<div class="accordion-header-content">
<span class="icon-wrapper rounded-4 bg-success-subtle text-success p-3">
<i class="bi bi-journal-code m-0 fs-4"></i>
</span>
...
<button class="accordion-button collapsed accordion-toggle-only" type="button"
  ...
  data-bs-target="#collapse-data-collection"
  aria-expanded="false"
  aria-label="Toggle Data Collection section"></button>
</div>

<div id="collapse-data-collection" class="accordion-collapse collapse">
...
::: {#data-collection-collapse .collapse-tabs}

<div class="collapse-heading">

### Lab Protocols {#sec-lab-protocols .no-anchor .collapse-toggle data-bs-toggle="collapse" data-bs-target="#collapse-lab-protocols" aria-expanded="true" aria-controls="collapse-lab-protocols"}

</div>
<div id="collapse-lab-protocols" class="collapse show" data-bs-parent="#data-collection-collapse">
...
#### <i class="bi bi-mortarboard"></i> LEARN MORE {#sec-lab-protocols-lm .orc-card-section .unnumbered}
...
<img src="/training/images/reproducibiliteach.jpg" class="img-fluid" alt="reproducibiliteach icon">
</div>
...
* [Write reusable protocols](https://youtu.be/aKiXFzj15dg?si=ilB8aOsXArphMpfm): Understand the level of details needed for your protocols.
:::
...
#### <i class="bi bi-tools"></i> TOOLS & RESOURCES {#sec-lab-protocols-tr .orc-card-section .unnumbered}
...
<div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
  <div class="d-flex gap-2">
    <div class="orc-card-tool-icon p-2 rounded">
      <img src="/assets/img/elabftw-logo.svg" class="img-fluid" alt="eLabFTW icon">
    </div>
  </div>
...
<p class="card-text">Electronic Lab Notebook, provided by the University Library.</p>
<a href="https://elab.ub.lmu.de/login.php" class="stretched-link" target="_blank" rel="noopener"></a>
</div>
```

::: {.content-visible unless-format="html"}
* [eLabFTW](https://elab.ub.lmu.de/login.php): Electronic Lab Notebook, provided by the University Library.
:::
...
<div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
  <div class="d-flex gap-2">
    <div class="orc-card-tool-icon p-2 rounded">
      <img src="/assets/img/chemotion-icon.png" class="img-fluid" alt="Chemotion icon">
    </div>
  </div>
  <span class="badge rounded-5 bg-success-subtle text-success align-self-start">Supported at LMU</span>
</div>
<h4 class="card-title">Chemotion</h4>
<p class="card-text">Electronic Lab Notebook, provided by the Faculty for Chemistry and Pharmacy.</p>
<a href="https://chemlab.cup.uni-muenchen.de/home" class="stretched-link" target="_blank" rel="noopener"></a>
</div>
```

::: {.content-visible unless-format="html"}
* [Chemotion](https://chemlab.cup.uni-muenchen.de/home): Electronic Lab Notebook, provided by the Faculty for Chemistry and Pharmacy.
:::
...
### Questionnaires {#sec-questionnaires .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-questionnaires" aria-expanded="false" aria-controls="collapse-questionnaires"}

</div>
<div id="collapse-questionnaires" class="collapse" data-bs-parent="#data-collection-collapse">
...
### Software-based data acquisition {#sec-software-based-data-acquisition .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-software-based-data-acquisition" aria-expanded="false" aria-controls="collapse-software-based-data-acquisition"}

</div>
<div id="collapse-software-based-data-acquisition" class="collapse" data-bs-parent="#data-collection-collapse">
...
#### <i class="bi bi-mortarboard"></i> LEARN MORE {#sec-software-based-data-acquisition-lm .orc-card-section .unnumbered}
<!-- row for learn more section  -->
...
<div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
  <div class="d-flex gap-2">
    ...
    <div class="orc-card-tool-icon p-2 rounded">
      <img src="/assets/img/Rlogo.svg" class="img-fluid" alt="R logo">
    </div>
  </div>
...
::: {.content-visible unless-format="html"}
* [Introduction to R](https://lmu-osc.github.io/introduction-to-R/): Programming fundamentals for research data processing (3h)
:::
...
<div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
  <div class="d-flex gap-2">
    ...
    <div class="orc-card-tool-icon p-2 rounded">
      <img src="/assets/img/git-icon-logo.svg" class="img-fluid" alt="Git logo">
    </div>
  </div>
  <span class="badge rounded-5 bg-success-subtle text-success align-self-start">OSC Tutorial</span>
</div>
...
::: {.content-visible unless-format="html"}
* [Introduction to Git](https://lmu-osc.github.io/Introduction-RStudio-Git-GitHub/): Learn Git basics integrated with RStudio (2h).
:::
...
### Field and lab work {#sec-field-and-lab-work .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-field-and-lab-work" aria-expanded="false" aria-controls="collapse-field-and-lab-work"}

</div>
<div id="collapse-field-and-lab-work" class="collapse" data-bs-parent="#data-collection-collapse">
...
- **Match the tool to the size of your project.** A relational database pays off for ongoing, multi-site, or long-term data entry, but for small or one-off projects a structured spreadsheet template is enough (see [2.2.3. File Formats](#sec-data-management){.mark} for the pitfalls to avoid)
...
#### <i class="bi bi-tools"></i> TOOLS & RESOURCES {#sec-field-and-lab-work-tr .orc-card-section .unnumbered}
<!-- row for Tools & Resources section -->
...
<div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
  <div class="d-flex gap-2">
    <div class="orc-card-tool-icon p-2 rounded">
      <img src="/assets/img/postgresql-favicon.ico" class="img-fluid" alt="PostgreSQL icon">
    </div>
  </div>
</div>
...
::: {.content-visible unless-format="html"}
* [PostgreSQL](https://www.postgresql.org/): Open source relational database software
:::
...
### Systematic reviews {#sec-systematic-reviews .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-systematic-reviews" aria-expanded="false" aria-controls="collapse-systematic-reviews"}

</div>
<div id="collapse-systematic-reviews" class="collapse" data-bs-parent="#data-collection-collapse">
...
#### <i class="bi bi-mortarboard"></i> LEARN MORE {#sec-systematic-reviews-lm .orc-card-section .unnumbered}
<!-- row for learn more section  -->
...
::: {.content-visible unless-format="html"}
* Systematic review: Slides and additional resources of workshop delivered at OSSS23.
:::
...
#### <i class="bi bi-tools"></i> TOOLS & RESOURCES {#sec-systematic-reviews-tr .orc-card-section .unnumbered}
<!-- row for Tools & Resources section -->
...
<div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
  <div class="d-flex gap-2">
    <div class="orc-card-tool-icon p-2 rounded">
      <img src="/assets/img/prisma-logo-color-white.png" class="img-fluid" alt="PRISMA icon">
    </div>
  </div>
</div>
...
::: {.content-visible unless-format="html"}
* [PRISMA](https://www.prisma-statement.org/): Preferred Reporting Items for Systematic review and Meta-Analysis Protocols
:::
...
<div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
  <div class="d-flex gap-2">
    <div class="orc-card-tool-icon p-2 rounded">
      <img src="/assets/img/camarades-favicon.ico" class="img-fluid" alt="CAMARADES icon">
    </div>
  </div>
</div>
...
::: {.content-visible unless-format="html"}
* [CAMARADES](https://camarades.de/): Step-by-step guide to Preclinical Systematic Review.
:::
...
<div class="accordion rh-accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordion-data-management">
<div class="accordion-item">
<div class="accordion-header no-anchor">
<div class="accordion-header-content">
<span class="icon-wrapper rounded-4 bg-success-subtle text-success p-3">
<i class="bi bi-folder-check m-0 fs-4"></i>
</span>
<div class="accordion-title">
...
<button class="accordion-button collapsed accordion-toggle-only" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapse-data-management"
  aria-expanded="false"
  aria-label="Toggle Data Management section"></button>
</div>
<div id="collapse-data-management" class="accordion-collapse collapse">
<div class="accordion-body p-4">

::: {.content}

In [[1. Plan & Design](01-plan-and-design.qmd){.mark}]{.content-visible when-format="html"}[ @sec-plan-and-design-chapter]{.content-hidden when-format="html"} you created a Research Data Management Plan. It's now time to put this plan into practice, refining it as you learn what actually works for your project.

::: {.ms-1} 

- **Keep your raw data as read-only files.** The unmodified output of your instruments, surveys, or observations should never be modified directly. You should provide enough documentation to recreate your processed datasets and results from your raw data (see [[3.1. Data Processing & Analyses](03-analyze-and-collaborate.qmd#sec-data-processing-analysis){.mark}]{.content-visible when-format="html"}[ @sec-data-processing-analysis]{.content-hidden when-format="html"}).
...
- **Assign responsibilities.** For developing such SOPs for a specific kind of project and for checking all members have implemented those SOPs at a specified time point in their project (e.g. hold a data quality validation meeting prior to starting data analyses, see [Collect & Manage Checklist](#sec-collect-and-manage-checklist){.mark}).
:::


::: {#data-management-collapse .collapse-tabs}

<div class="collapse-heading">

### Storage {#sec-storage .no-anchor .collapse-toggle data-bs-toggle="collapse" data-bs-target="#collapse-storage" aria-expanded="true" aria-controls="collapse-storage"}

</div>
<div id="collapse-storage" class="collapse show" data-bs-parent="#data-management-collapse">

This section covers storage for data you are actively collecting. Long-term archiving for sharing is covered in [[4. Preserve & Share](04-preserve-and-share.qmd){.mark}]{.content-visible when-format="html"}[ @sec-preserve-and-share-chapter]{.content-hidden when-format="html"}.
...
#### <i class="bi bi-mortarboard"></i> LEARN MORE {#sec-storage-lm .orc-card-section .unnumbered}
<!-- row for Learn More section -->
...
<div class="card orc-card-tool p-3 bg-light-subtle h-100">
    <div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
        <div class="d-flex gap-2">
            <div class="orc-card-tool-icon p-2 rounded">
            <img src="/assets/img/lrz-logo.png" class="img-fluid" alt="LRZ logo">
            </div>
        </div>
        <span class="badge rounded-5 bg-success-subtle text-success align-self-start">Supported at LMU</span>
    </div>
...
::: {.content-visible unless-format="html"}
* [LRZ Sync & Share](https://syncandshare.lrz.de/login): Cloud storage service for LMU Munich
:::
...
::: {.content-visible unless-format="html"}
* [LRZ DSS](https://doku.lrz.de/data-science-storage-10745685.html): Long-term archival storage for LMU Munich
:::
...
::: {.content-visible unless-format="html"}
* [OSF](https://osf.io/): Research project management platform including storage.
:::
...
### Organization {#sec-organization .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-organization" aria-expanded="false" aria-controls="collapse-organization"}

</div>
<div id="collapse-organization" class="collapse" data-bs-parent="#data-management-collapse">
...
#### <i class="bi bi-mortarboard"></i> LEARN MORE {#sec-organization-lm .orc-card-section .unnumbered}
...
::: {.content-visible unless-format="html"}
* [Data Organization](https://lmu-osc.github.io/FAIR-Data-Management/data-organisation.html): Folder structure and naming conventions. (30 min)
:::
...
#### <i class="bi bi-tools"></i> TOOLS & RESOURCES {#sec-organization-tr .orc-card-section .unnumbered}
<!-- row for Tools & Resources section -->
...
<div class="card orc-card-tool p-3 bg-light-subtle h-100">
    <div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-3">
        <div class="d-flex gap-2">
            ...
            <div class="orc-card-tool-icon p-2 rounded">
            <img src="/assets/img/github.svg"  class="img-fluid" alt="GitHub logo">
            </div>
        </div>
...
::: {.content-visible unless-format="html"}
* [Research Project Template](https://github.com/lmu-osc/research-project-template): Project folder separating raw & processed data, code, and outputs.
:::
...
::: {.content-visible unless-format="html"}
* [RDMkit](https://rdmkit.elixir-europe.org/your_domain): Domain-specific data management standards
:::
...
### File Formats {#sec-file-formats .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-file-formats" aria-expanded="false" aria-controls="collapse-file-formats"}

</div>
<div id="collapse-file-formats" class="collapse" data-bs-parent="#data-management-collapse">
...
#### <i class="bi bi-tools"></i> TOOLS & RESOURCES {#sec-file-formats-tr .orc-card-section .unnumbered}
...
::: {.content-visible unless-format="html"}
* [RDMkit](https://rdmkit.elixir-europe.org/your_domain): Domain-specific file formats and conventions
:::
...
### Documentation {#sec-documentation-02 .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-documentation-02" aria-expanded="false" aria-controls="collapse-documentation-02"}

</div>
<div id="collapse-documentation-02" class="collapse" data-bs-parent="#data-management-collapse">
...
#### <i class="bi bi-mortarboard"></i> LEARN MORE {#sec-documentation-02-lm .orc-card-section .unnumbered}
...
::: {.content-visible unless-format="html"}
* [Principles of Data Documentation](https://lmu-osc.github.io/FAIR-Data-Management/documentation.html): Principles of README files and data dictionaries.
:::
...
::: {.content-visible unless-format="html"}
* [Data Documentation & Validation](https://lmu-osc.github.io/data-documentation-validation-R/): Create READMEs, data dictionaries, and validation checks for your data. (1h)
:::
...
### Standards {#sec-standards .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-standards" aria-expanded="false" aria-controls="collapse-standards"}

</div>
<div id="collapse-standards" class="collapse" data-bs-parent="#data-management-collapse">
...
#### <i class="bi bi-tools"></i> TOOLS & RESOURCES {#sec-standards-tr .orc-card-section .unnumbered}
...
<div class="card orc-card-tool p-3 bg-light-subtle h-100">
    <div class="orc-card-tool-icon p-2 rounded mb-3" style="width:fit-content;"> 
        <img src="/assets/img/equator-logo.jpg" class="img-fluid" alt="EQUATOR logo">
    </div>
...
::: {.content-visible unless-format="html"}
* [EQUATOR Network](https://www.equator-network.org/reporting-guidelines/): Comprehensive database of reporting guidelines.
:::
...
### Version Control {#sec-version-control-02 .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-version-control-02" aria-expanded="false" aria-controls="collapse-version-control-02"}

</div>
<div id="collapse-version-control-02" class="collapse" data-bs-parent="#data-management-collapse">
...
#### <i class="bi bi-mortarboard"></i> LEARN MORE {#sec-version-control-02-lm .orc-card-section .unnumbered}
...
::: {.content-visible unless-format="html"}
* [Introduction to GitHub](https://lmu-osc.github.io/Collaborative-RStudio-GitHub/): Connect to GitHub from Git within RStudio (1h).
:::
...
#### <i class="bi bi-tools"></i> TOOLS & RESOURCES {#sec-version-control-02-tr .orc-card-section .unnumbered}
<!-- row for Tools & Resources section -->
...
<div class="card orc-card-tool p-3 bg-light-subtle h-100">
    ...
    <div class="d-flex gap-2">
        ...
        <div class="orc-card-tool-icon p-2 rounded">
            <img src="/assets/img/gitlab.svg" class="img-fluid" alt="GitLab logo">
        </div>
    </div>
    <span class="badge rounded-5 bg-success-subtle text-success align-self-start">Supported at LMU</span>
    </div>
...
::: {.content-visible unless-format="html"}
* [LRZ Gitlab](https://gitlab.lrz.de/): Institutional Git hosting for LMU Munich.
:::
...
<div class="card orc-card-tool p-3 bg-light-subtle h-100">
    <div class="orc-card-tool-icon p-2 rounded mb-3" style="width:fit-content;"> 
        <img src="/assets/img/datalad-logo.svg" class="img-fluid" alt="DataLad icon">
    </div>
...
::: {.content-visible unless-format="html"}
* [DataLad](https://www.datalad.org/): Version control for large datasets
:::
...
<div class="accordion rh-accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordion-ethics-and-privacy">
<div class="accordion-item">
<div class="accordion-header no-anchor">
<div class="accordion-header-content">
<span class="icon-wrapper rounded-4 bg-success-subtle text-success p-3">
<i class="bi bi-shield-lock m-0 fs-4"></i>
</span>
<div class="accordion-title">
...
<button class="accordion-button collapsed accordion-toggle-only" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapse-ethics-and-privacy"
  aria-expanded="false"
  aria-label="Toggle Ethics & Privacy section"></button>
</div>
<div id="collapse-ethics-and-privacy" class="accordion-collapse collapse">
<div class="accordion-body p-4">

::: {.content}

Research involving human participants requires ethics approval and data protection compliance. In your ethics proposal (see [[1.2.3. Ethics](01-plan-and-design.qmd#sec-legal-requirements){.mark}]{.content-visible when-format="html"}[ @sec-legal-requirements]{.content-hidden when-format="html"}) you planned for safeguards for the people contributing to your research and you now need to implement them before or while collecting your data.


::: {#ethics-privacy-collapse .collapse-tabs}

<div class="collapse-heading">

### Informed Consent {#sec-informed-consent .no-anchor .collapse-toggle data-bs-toggle="collapse" data-bs-target="#collapse-informed-consent" aria-expanded="true" aria-controls="collapse-informed-consent"}

</div>
<div id="collapse-informed-consent" class="collapse show" data-bs-parent="#ethics-privacy-collapse">
...
#### <i class="bi bi-tools"></i> TOOLS & RESOURCES {#sec-informed-consent-tr .orc-card-section .unnumbered}
<!-- row for Tools & Resources section -->
...
<div class="card orc-card-tool p-3 bg-light-subtle h-100">
    <div class="orc-card-tool-icon p-2 rounded mb-3" style="width:fit-content;"> 
        <img src="/assets/img/utrecht-uni-icon.png" class="img-fluid" alt="University of Utrecht icon">
    </div>
...
::: {.content-visible unless-format="html"}
* [How to write an informed consent form](https://www.uu.nl/en/research/research-data-management/guides/legal-considerations/how-to-write-an-informed-consent-form): University of Utrecht RDM guide.
:::
...
### Anonymization {#sec-anonymization .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-anonymization" aria-expanded="false" aria-controls="collapse-anonymization"}

</div>
<div id="collapse-anonymization" class="collapse" data-bs-parent="#ethics-privacy-collapse">
...
#### <i class="bi bi-mortarboard"></i> LEARN MORE {#sec-anonymization-lm .orc-card-section .unnumbered}
...
### GDPR Compliance {#sec-gdpr-compliance .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-gdpr-compliance" aria-expanded="false" aria-controls="collapse-gdpr-compliance"}

</div>
<div id="collapse-gdpr-compliance" class="collapse" data-bs-parent="#ethics-privacy-collapse">
...
<div class="accordion rh-accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordion-quality-control">
<div class="accordion-item">
<div class="accordion-header no-anchor">
<div class="accordion-header-content">
<span class="icon-wrapper rounded-4 bg-success-subtle text-success p-3">
<i class="bi bi-check2-square m-0 fs-4"></i>
</span>
<div class="accordion-title">
...
<button class="accordion-button collapsed accordion-toggle-only" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapse-quality-control"
  aria-expanded="false"
  aria-label="Toggle Quality Control section"></button>
</div>
<div id="collapse-quality-control" class="accordion-collapse collapse">
<div class="accordion-body p-4">
...
**Define criteria before looking at your data.** This prevents unconscious bias in what you keep and exclude, and demonstrates that your decisions are principled rather than convenient (see [[1.4. Study Design & Analysis Plan](01-plan-and-design.qmd#sec-study-design-analysis-plan){.mark}]{.content-visible when-format="html"}[ @sec-study-design-analysis-plan]{.content-hidden when-format="html"}).

::: {#quality-control-collapse .collapse-tabs}

<div class="collapse-heading">

### Validation {#sec-validation .no-anchor .collapse-toggle data-bs-toggle="collapse" data-bs-target="#collapse-validation" aria-expanded="true" aria-controls="collapse-validation"}

</div>
<div id="collapse-validation" class="collapse show" data-bs-parent="#quality-control-collapse">
...
#### <i class="bi bi-mortarboard"></i> LEARN MORE {#sec-validation-lm .orc-card-section .unnumbered}
...
::: {.content-visible unless-format="html"}
* [Data Documentation & Validation](https://lmu-osc.github.io/data-documentation-validation-R/): Create validation rules and automated checks for your research data. (1h)
:::
...
### Cleaning {#sec-cleaning .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-cleaning" aria-expanded="false" aria-controls="collapse-cleaning"}

</div>
<div id="collapse-cleaning" class="collapse" data-bs-parent="#quality-control-collapse">
...
### Exclusions {#sec-exclusions .no-anchor .collapse-toggle .collapsed data-bs-toggle="collapse" data-bs-target="#collapse-exclusions" aria-expanded="false" aria-controls="collapse-exclusions"}

</div>
<div id="collapse-exclusions" class="collapse" data-bs-parent="#quality-control-collapse">

Exclusion criteria specify which data points will be removed from analysis and why. Define these before you see your results (see [[1.4. Study Design & Analysis Plan](01-plan-and-design.qmd#sec-study-design-analysis-plan){.mark}]{.content-visible when-format="html"}[ @sec-study-design-analysis-plan]{.content-hidden when-format="html"}).
...
## <i class="bi bi-card-checklist checklist-icon"></i> Collect & Manage Checklist {#sec-collect-and-manage-checklist .unnumbered}
