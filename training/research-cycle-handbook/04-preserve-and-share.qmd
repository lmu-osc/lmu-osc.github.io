...
- [ ] Add an open licence (e.g. CC.BY 4.0 for data and materials, Apache 2.0 for code)
- [ ] Fill out the metadata of the repository where the resources are deposited
- [ ] Link authors's ORCID, and the ROR of their organisation and funders to all resources
- [ ] Release publically and get a DOI
- [ ] Modify the metadata of all resources to include the DOIs of other conencted resources

**Upon submitting an article**

- [ ] Include the DOI of all resources in MS (data, code, materials, conceptual figures)
- [ ] Use CRediT taxinomy to give attribution to all contributors
- [ ] Deposit a preprint on preprint server or institutional repository (if allowed)
- [ ] Request an open licence (CC.BY 4.0) for the article if possible to allow redistribution

**After acceptance of an article**

- [ ] Udate the preprint with a postprint (if allowed)
- [ ] Link the DOI of the published article to the preprint/postprint
- [ ] Handle data accesss requests if only metadat were shared
