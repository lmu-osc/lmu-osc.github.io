...
<div class="accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle">
<div class="accordion-item">
<h2 class="accordion-header no-anchor" id="sec-fair-data-sharing">
<button class="accordion-button collapsed fw-semibold d-flex align-items-center gap-3" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapseOne"
  aria-expanded="false">
<span class="icon-wrapper rounded-4 bg-success-subtle text-primary p-3">
<i class="bi bi-database-up m-0 fs-5"></i> 
</span>
<div class="accordion-title">

### FAIR Data Sharing {.fs-5}
</div>
</button>
</h2>
...
<div class="accordion-item">
<h2 class="accordion-header no-anchor" id="sec-open-source-code">
<button class="accordion-button collapsed fw-semibold d-flex align-items-center gap-3" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapseTwo"
  aria-expanded="false">
<span class="icon-wrapper rounded-4 bg-success-subtle text-primary p-3 d-flex align-items-center justify-content-center">
<i class="bi bi-file-code m-0 fs-5"></i> 
</span>
<div class="accordion-title">

### Open Source Code {.fs-5}
</div>
</button>
</h2>
...
<div class="accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordionExample">
<div class="accordion-item">
<h2 class="accordion-header no-anchor" id="sec-open-materials">
<button class="accordion-button collapsed fw-semibold d-flex align-items-center gap-3" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapseThree"
  aria-expanded="false">
<span class="icon-wrapper rounded-4 bg-success-subtle text-primary p-3 d-flex align-items-center justify-content-center">
<i class="bi bi-journal-arrow-up m-0 fs-5"></i> 
</span>
<div class="accordion-title">
...
<div class="accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordionExample">
<div class="accordion-item">
<h2 class="accordion-header no-anchor" id="sec-open-access-articles">
<button class="accordion-button collapsed fw-semibold d-flex align-items-center gap-3" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapseFour"
  aria-expanded="false">
<span class="icon-wrapper rounded-4 bg-success-subtle text-primary p-3 d-flex align-items-center justify-content-center">
<i class="bi bi-unlock2 m-0 fs-5"></i> 
</span>
<div class="accordion-title">

### Open Access Articles {.fs-5}
</div>
</button>
</h2>
...
<div class="accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordionExample">
<div class="accordion-item">
<h2 class="accordion-header no-anchor" id="sec-attributions-and-persistent-identifiers">
<button class="accordion-button collapsed fw-semibold d-flex align-items-center gap-3" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapseFive"
  aria-expanded="false">
<span class="icon-wrapper rounded-4 bg-success-subtle text-primary p-3 d-flex align-items-center justify-content-center">
<i class="bi bi-person-badge m-0 fs-5"></i> 
</span>
<div class="accordion-title">

### Attributions & Persistent Identifiers {.fs-5}
</div>
</button>
</h2>
