...
## Preserve & Share Phase {#sec-preserve-and-share .visually-hidden}
...
In @sec-plan-and-design, you wrote a Data Management Plan, in @sec-collect-and-manage, you created documentation for yourself, and in @sec-analyze-and-collaborate you updated that documentation for your collaborators. Now you prepare that documentation for people who have no prior knowledge of your project and reassess you plan:
...
Not all data can or should be shared openly. Your sharing options depend on what consent participants gave and what your ethics approval permits (see @sec-legal-requirements).
...
- Consider whether the data can be **anonymized** without losing scientific value (see @sec-ethics-and-privacy).
...
So far, your code was either backed up on the secured [LRZ Gitlab](https://gitlab.lrz.de/) (e.g. if your data and/or code are sensitive), or on [GitHub](https://github.com/)  (see @sec-analyze-and-collaborate). Before the submission of a manuscript to a journal and/or upon the acceptance of a manuscript, there are small additional steps that need to be done to publish your code.

::: {.ms-1} 
- **verify** the structure of your repository, the readability of your scripts, the completeness of the documentation (see @sec-analyze-collaborate-checklist).
...
::: {.ms-1} 
- **generate a simulated random dataset** to allow for the published code to run (which you may have already done if you simulated data in order to prepare a preregistration, see @sec-study-design-analysis-plan), _or_ 
...
- **Share wet-lab protocols** on e.g. [protocols.io](https://www.protocols.io/), see @sec-data-collection.
...
We recommend to **start discussions on authorship, roles, and responsibilities as early as possible**. First discussions can for instance take place at the end of @sec-plan-and-design, e.g. during the presentation of the study plan to the research group (see @sec-plan-design-checklist). As roles may shift in the course of a project, a review is warranted at the write-up stage. 
...
## <i class="bi bi-card-checklist checklist-icon"></i> Preserve & Share Checklist {#sec-preserve-share-checklist}
