...
<div class="accordion handbook-accordion my-4 mx-2 rounded-3 shadow-sm bg-light-subtle" id="accordionExample">
<div class="accordion-item">
<h2 class="accordion-header no-anchor" id="sec-data-processing-analysis">
...
<i class="bi bi-gear-wide-connected m-0 fs-5"></i> 
</span>
<div class="accordion-title">

### Data Processing & Analysis {.fs-5}
</div>
</button>
</h2>
...
<div class="accordion-item">
<h2 class="accordion-header no-anchor fs-6" id="sec-reporting-results">
<button class="accordion-button collapsed fw-semibold d-flex align-items-center gap-3" type="button"
  data-bs-toggle="collapse"
  data-bs-target="#collapseTwo"
  aria-expanded="false">
<span class="icon-wrapper rounded-4 bg-success-subtle text-primary p-3">
<i class="bi bi-file-earmark-richtext m-0 fs-5"></i> 
</span>
<div class="accordion-title">

### Reporting Results {.fs-5}
</div>
</button>
</h2>
