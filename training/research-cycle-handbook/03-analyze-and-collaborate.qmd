...
<p class="card-text">Institutional chat service for LMU Munich.</p>
...
::: {.content-visible unless-format="html"}
* [LMU Chat (Matrix)](https://www.lmu.de/en/about-lmu/structure/central-university-administration/it-services-division/it-service-desk/central-it-services/lmu-chat-matrix/): Institutional chat service for LMU Munich.
:::
