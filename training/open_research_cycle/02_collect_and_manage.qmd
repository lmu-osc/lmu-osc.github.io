...
<summary><i class="bi bi-journal-code"></i> 2.1. Data Collection</summary>
...
<!-- 2 cards in learn more in one row -->
::: {.orc-grid-tools}
::: {.orc-card-tool}
<div class="orc-card-tool-icon"><img src="../../assets/img/lmu_osc_logo.jpg" alt="LMU OSC"></div>

#### [Introduction to R](https://lmu-osc.github.io/introduction-to-R/) <!-- add R icon -->
...
<details class="orc-details-panel">
<summary><i class="bi bi-folder-check"></i> 2.2. Data Management</summary>

In [1. Plan & Design](<!-- internal link-->) you created a Research Data Management Plan. It's now time to put this plan into practice, refining it as you learn what actually works for your project.
...
- **Keep your raw data as read-only files.** The unmodified output of your instruments, surveys, or observations should never be modified directly. You should provide enough documentation to recreate your processed datasets and results from your raw data (see [3.1. Reproducible Data Processing & Analyses](<!--internal link-->)).
...
Project folder that separates raw data, processed data, code, and outputs.
...
<!-- logo https://rdmkit.elixir-europe.org/assets/img/apple-touch-icon.png-->
...
Format issues often surface during quality control. The [2.4. Quality Control](<!--internal link-->) panel below covers validation checks that can catch encoding problems, unexpected conversions, and structural inconsistencies early.
...
While your LRZ GitLab account is associated with your LMU Munich affiliation, your GitHub account can be associated with your private email, be included in your CV, and be used for public sharing of your data and code (see [3. Analyze & Collaborate](<!-- internal link -->) and [4. Preserve & Share](<!-- internal link -->)).  
<br>
...
#### [Introduction to Git](https://lmu-osc.github.io/Introduction-RStudio-Git-GitHub/) <!-- add OSC tutorial tag and git logo - learn more section -->

Learn Git basics integrated with RStudio (2h)

:::

<!-- add github tutorial card https://ree-gupta.github.io/lmu-osc.github.io/training/open_research_cycle/02_collect_and_manage_website.html#github  with OSC tutorial tag and github logo - learn more section -->



<!-- in tool section: add LRZ gitlab - LMU supported tool card https://ree-gupta.github.io/lmu-osc.github.io/training/open_research_cycle/02_collect_and_manage_website.html#lrz-gitlab  Institutional Git hosting for LMU Munich --> 
...
<details class="orc-details-panel">
<summary><i class="bi bi-shield-lock"></i> 2.3. Ethics & Privacy</summary> 
...
:::
<!-- card learn more with OSC tutorials on 

Data Anonymization TBA mid 2026 
R anonymization techniques for safely sharing sensitive research data 

https://lmu-osc.github.io/synthetic-data-tutorial/ Synthetic Data
Synthetic data creation in R to balance utility and privacy when sharing data
...
<details class="orc-details-panel">
<summary><i class="bi bi-check2-square"></i> 2.4. Quality Control</summary>
...
**Define criteria before looking at your data.** This prevents unconscious bias in what you keep and exclude, and demonstrates that your decisions are principled rather than convenient (see [1.4. Study Design & Analysis Plan](<!--internal link-->)).
...
Exclusion criteria specify which data points will be removed from analysis and why. Define these before you see your results (see [1.4. Study Design & Analysis Plan](<!--internal link-->)).
...
## <i class="bi bi-card-checklist"></i> Data Management Checklist
