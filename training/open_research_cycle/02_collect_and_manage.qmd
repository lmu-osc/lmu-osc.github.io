...
<img src="https://upload.wikimedia.org/wikipedia/commons/9/95/Zotero_icon.png" class="img-fluid" alt="Rlogo">
</div>
</div>
...
<div class="orc-card-tool-icon icon-2">
<img src="https://upload.wikimedia.org/wikipedia/commons/9/95/Zotero_icon.png" class="img-fluid" alt="Git logo">
</div>
</div>
...
**Define criteria before looking at your data.** This prevents unconscious bias in what you keep and exclude, and demonstrates that your decisions are principled rather than convenient (see [1.4. Study Design & Analysis Plan](01_plan_and_design_website.qmd#1-4-study-design-analysis-plan){.mark}).
...
Exclusion criteria specify which data points will be removed from analysis and why. Define these before you see your results (see [1.4. Study Design & Analysis Plan](01_plan_and_design_website.qmd#1-4-study-design-analysis-plan){.mark}).
