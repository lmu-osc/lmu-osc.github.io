...
::: {.orc-grid-tools} 
<!-- add a card to LMU supported ENL (LMU hosted version of this https://www.elabftw.net/ I believe -->
::: {.orc-card-tool}
...
<!-- 2 cards in learn more: R and Git tutorials  -->
::: {.orc-grid-tools}
::: {.orc-card-tool}
...
::: {.orc-grid-tools}
::: {.orc-card-tool}
<div class="orc-card-tool-icon"><img src="https://cdn.simpleicons.org/github" alt="GitHub"></div> <!-- use OSC logo and GitHub Logo, tag OSC Tool in Tools & resources section-->
...
#### [Introduction to Git](https://lmu-osc.github.io/Introduction-RStudio-Git-GitHub/) <!-- add OSC tutorial tag -->
...
<details class="orc-details-panel">
<summary><i class="bi bi-shield-lock"></i> Ethics & Privacy</summary> <!-- change logo to this one https://ree-gupta.github.io/lmu-osc.github.io/training/open_research_cycle/02_collect_and_manage_website.html#quality-security -->
