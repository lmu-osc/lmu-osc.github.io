...
<summary><i class="bi bi-journal-code"></i><h4>2.1. Data Collection</h4></summary>
...
<!-- add 3 tool cards in one row:
eLabFTW https://elab.ub.lmu.de/login.php with logo: https://www.elabftw.net/img/elabftw-logo-only.svg 
Electronic Lab Notebook hosted by LMU Munich. Tagged: LMU supported.

Chemotion https://chemlab.cup.uni-muenchen.de/home logo: https://avatars.githubusercontent.com/u/83013380?v=4
Electronic Lab Notebook hosted by the LMU Faculty for Chemistry and Pharmacy. Tagged: LMU supported.

Protocols.io [protocols.io](https://www.protocols.io/) icon: https://www.protocols.io/favicon.ico 
...
<span class="orc-card-tool-badge recommended">LMU supported</span>
...
<p class="card-text">Electronic Lab Notebook hosted by the LMU Faculty for Chemistry and Pharmacy. </p>
...
- **Structure data correctly from the start.** Variables in columns, observations in rows. This makes your data immediately interoperable with analysis tools rather than requiring cleanup later. Scripts can also automate organization, file renaming, and conversion to open formats. See  [2.2. Data Management](#2-2-data-management){.mark} for guidelines.
...
<p class="card-text">Programming fundamentals for research data processing</p>
...
<details class="orc-details-panel">
<summary><i class="bi bi-folder-check"></i><h4> 2.2. Data Management </h4></summary>
...
<!-- adding space before list didnt work hence "faking" nested look by adding margin  in case you choose to keep it.-->

::: {.ms-2}

- **Keep your raw data as read-only files.** The unmodified output of your instruments, surveys, or observations should never be modified directly. You should provide enough documentation to recreate your processed datasets and results from your raw data (see [3.1. Reproducible Data Processing & Analyses](<!-- to update once chapter 3 formatted-->)).
...
<!-- add LRZ Sync & Share card https://ree-gupta.github.io/lmu-osc.github.io/training/open_research_cycle/02_collect_and_manage_website.html#lrz-sync-share logo: https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvQdlBHTP2IOvBeJ_S8I9z9S2BX0Qqn0twjw&s-->
<!-- add LRZ DSS card https://ree-gupta.github.io/lmu-osc.github.io/training/open_research_cycle/02_collect_and_manage_website.html#lrz-dss logo https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvQdlBHTP2IOvBeJ_S8I9z9S2BX0Qqn0twjw&s-->
<!-- add OSF card https://ree-gupta.github.io/lmu-osc.github.io/training/open_research_cycle/02_collect_and_manage_website.html#osf with the right OSF logo : https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Open_Science_Framework_log_%28and_Center_for_Open_Science_logo%29.svg/3840px-Open_Science_Framework_log_%28and_Center_for_Open_Science_logo%29.svg.png-->
...
<p class="card-text">LRZ Sync & Share</p>
...
<div class="orc-card-tool-icon icon-2">
<img src="https://cdn.simpleicons.org/github"  class="img-fluid" alt="GitHub">
</div>
</div>
<h4 class="card-title">Research Project Template</h4>
<p class="card-text">Project folder that separates raw data, processed data, code, and outputs.</p>
...
Format issues often surface during quality control. The [2.4. Quality Control](#2-4-quality-control){.mark} panel below covers validation checks that can catch encoding problems, unexpected conversions, and structural inconsistencies early.
...
<h4 class="card-title">RDMkit</h4>
<p class="card-text"> Find recommended file formats and conventions for your research field.</p>
<a href="https://rdmkit.elixir-europe.org/your_domain" class="stretched-link" target="_blank" rel="noopener"></a>
</div>
...
<p class="card-text">Create effective READMEs, data dictionaries, and validation checks for your research data.</p>
...
<h4 class="card-title">Research Project Template</h4>
<p class="card-text">Project template with README and data dictionaries included. </p>
<a href="https://github.com/lmu-osc/research-project-template" class="stretched-link" target="_blank" rel="noopener"> </a>
</div>
...
<h4 class="card-title">RDMkit</h4>
<p class="card-text">Find metadata standards and requirements specific to your research field.</p>
<a href="https://rdmkit.elixir-europe.org/your_domain" class="stretched-link" target="_blank" rel="noopener"> </a>
</div>
...
<span class="orc-card-tool-badge recommended">LMU supported</span>
<div class="orc-card-tool-icon mb-2"> 
<img src="https://about.gitlab.com/images/press/gitlab-logo-100-rgb.svg" class="img-fluid" alt="GitLab icon">
</div>
<h4 class="card-title">LRZ Gitlab</h4>
<p class="card-text">Institutional Git hosting for LMU Munich.</p>
<a href="https://ree-gupta.github.io/lmu-osc.github.io/training/open_research_cycle/02_collect_and_manage_website.html#lrz-gitlab" class="stretched-link" target="_blank" rel="noopener"></a>
</div>
...
<details class="orc-details-panel">
<summary><i class="bi bi-shield-lock"></i><h4> 2.3. Ethics & Privacy</h4></summary> 
...
<details class="orc-details-panel">
<summary><i class="bi bi-check2-square"></i><h4> 2.4. Quality Control </h4></summary>
...
**Define criteria before looking at your data.** This prevents unconscious bias in what you keep and exclude, and demonstrates that your decisions are principled rather than convenient (see [1.4. Study Design & Analysis Plan](01_plan_and_design.qmd#1-4-study-design-analysis-plan){.mark}).
...
Exclusion criteria specify which data points will be removed from analysis and why. Define these before you see your results (see [1.4. Study Design & Analysis Plan](01_plan_and_design.qmd#1-4-study-design-analysis-plan){.mark}).
...
## <i class="bi bi-card-checklist checklist-icon"></i> Data Management Checklist
