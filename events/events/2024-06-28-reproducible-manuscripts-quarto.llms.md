...
[Quarto](https://quarto.org/) (the successor of R Markdown) is a popular open-source software for writing reproducible scientific manuscripts. It can also produce websites, blogs, books, presentations, dashboards and much more. Quarto can be used together with R, Python or Julia. If you want to learn how to use Quarto and write reproducible scientific manuscripts with R, we have prepared a [self-paced online tutorial](https://lmu-osc.github.io/introduction-to-Quarto/) for you.
