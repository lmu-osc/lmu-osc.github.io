...
if (has_end_date) {
  ...
  if (is.na(event_date_formatted) || is.na(event_end_date_formatted)) {
    date_display <- paste0(event_date, " - ", event_end_date)
  } else if (lubridate::year(event_date_formatted) == lubridate::year(event_end_date_formatted)) {
    date_display <- paste0(
