...
During a longer break, the concept was slightly revised, and the organization team intends to invite the speaker(s) of the respective paper that will be discussed in each session. From now on, the author herself/himself will start with the introductory talk including a short summary of the paper. Afterwards, there will be enough time for direct interaction with the author(s) and, as before, an open discussion with all of the participants.
