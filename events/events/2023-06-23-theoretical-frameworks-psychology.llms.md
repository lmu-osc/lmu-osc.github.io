...
The Journal Club: “ReproducibiliTea” at LMU Munich continues with its 18th meeting, the sixth one for this semester. It will take place this Friday and we will talk about the Theoretical Frameworks. Following a quick introduction into Muthukrishna et. al. paper “A problem in theory”, that stresses the importance of cumulative theoretical framework in order to mitigate the replication crisis and to pave the way toward a more general theory of human behavior, we would like to discuss whether these frameworks could actually be Lifesavers for Psychology.

**Procedure:** One member of our organizing team will introduce (approx. 20 minutes) the paper. We will then continue with an open discussion where you can contribute your own thoughts and questions. Finally, there will be time to get to know each other and talk in smaller groups.
