...
## Join the LMU Open Science Center [Safeguar.de](https://safeguar.de/) Hackathon

At this hands-on event, we welcome Henrik Schönemann (HU Berlin), an initiator of [safeguar.de](https://safeguar.de/), for an ignition talk. In the practical part, we will directly support the data rescue efforts:
