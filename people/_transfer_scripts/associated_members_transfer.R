...
associated_members_raw_url <- "https://raw.githubusercontent.com/lmu-osc/osc-website-transfer/refs/heads/main/associated_members.csv?token=GHSAT0AAAAAADNSJCJMZRZ5STSSX47X7ECO2HXLUVQ"

associated_members_table <- read_csv(associated_members_raw_url) %>%
...
# View(associated_members_table)

quarto_page <- associated_members_table %>%
...
pmap(list(quarto_page, associated_members_table$First_name, associated_members_table$Surname), ~{
