...
mission_statement:
  - "Malika Ihle is the LMU Open Science Center Coordinator developing a comprehensive approach to open research that extends across all disciplines at LMU Munich, using both bottom-up and top-down strategies."
  - "Her role is to
- provide peer-to-peer training and develop an open research curriculum,
- coordinate grassroots initiatives and organise various events,
- support meta-research collaborations,
- liaise with local, national, and international stakeholders to inform the design of incentives and policies,
- and co-develop a strategic plan to make the OSC a key sustainable entity benefiting LMU Munich"
  - "Malika is the German Reproducibility Network ([GRN](https://reproducibilitynetwork.de/)) local network lead."
  - "Prior to this, Malika was in a similar role for 2.5 years at the University of Oxford, coordinating Reproducible Research Oxford ([RROx](https://ox.ukrn.org/)) and acting as the UK Reproducibility Network ([UKRN](https://www.ukrn.org/)) local network lead."
  - "Malika holds a PhD in Biology, and is a founding member of the Society for Open, Reliable, and Transparent Ecology and Evolutionary biology ([SORTEE](https://www.sortee.org/))."
...
publications: 
  ...
  # - O’Dea RE, Parker TH, ..., Ihle M, ..., Nakagawa S. 2021. **Towards open, reliable, and transparent ecology and evolutionary biology.** BMC Biology. https://doi.org/10.1186/s12915-021-01006-3
  # - Kohrs FE, ..., Ihle M, ..., Weissgerber TL.2023. **Eleven strategies for making reproducible research and open science training the norm at research institutions.** eLife. https://doi.org/10.7554/eLife.89736 
  # - Schönbrodt F, Gärtner A, ..., Ihle M, ..., Leising D. 2025. **Responsible Research Assessment I: Implementing DORA for hiring and promotion in psychology.** Meta-Psychology. https://doi.org/10.15626/MP.2024.4601
  # - Kniffert S, ..., Ihle M, ..., de Boer MR. 2025. **Research methodology education in Europe: a multi-country, cross-disciplinary survey of current practices and perspectives.** Research Integrity and Peer Review. https://doi.org/10.1186/s41073-025-00183-x 
---
