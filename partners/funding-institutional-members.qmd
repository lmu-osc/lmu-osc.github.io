...
<div class="member-grid">
    <div class="profile-link">
        <div class="member-grid-item">
            ...
            <a href="/people/people/thomas-kuhr.qmd" class="contact-link">Prof. Dr. Thomas Kuhr</a>
...
<div class="profile-link" >
    <div class="member-grid-item">
        ...
        <div class="member-grid-faculty">Contact Person: </div>
        <a href="/people/people/martin-dichgans.qmd" class="contact-link">Prof. Dr. Martin Dichgans</a>
        <div class="member-socials">
...
<div class="profile-link">
    <div class="member-grid-item">
        ...
        <div class="member-grid-faculty">Contact Person: </div>
        <a href="/people/people/felix-schoenbrodt.qmd" class="contact-link">Prof. Dr. Felix Schönbrodt</a>
        <div class="member-socials">
...
<div class="profile-link">
    <div class="member-grid-item">
        ...
        <div class="member-grid-faculty">Contact Person: </div>
        <a href="/people/people/niels-dingemanse.qmd" class="contact-link">Prof. Dr. Niels Dingemanse</a>
        <div class="member-socials">
...
<div class="profile-link">
    <div class="member-grid-item">
        ...
        <div class="member-grid-faculty">Contact Person: </div>
        <a href="/people/people/ralf-elsas.qmd" class="contact-link">Prof. Dr. Ralf Elsas</a>
        <div class="member-socials">
